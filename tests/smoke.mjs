...
for (const text of ["部署目标", "远程 SSH", "本机部署", "安装方式与部署", "部署完成", "故障演示", "部署失败", "DEPLOY-IMG-401", "修改认证信息", "重新部署", "暗色", "亮色", "下载交付清单", "登录系统"]) assert.ok(html.includes(text), `Missing static UI text: ${text}`);
assert.ok(!html.includes("跟随系统"), "System theme mode should not be displayed");
